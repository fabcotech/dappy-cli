...
module.exports.deployDataToSign = payment => {
  return new Promise((resolve, reject) => {
    load("./protobuf2/DeployService.proto", function(err, root) {
      if (err) {
        reject(err);
...
module.exports.getDeployData = async (
  ...
  const toSign = await module.exports.deployDataToSign(new Uint8Array(payment));

  const hash = module.exports.getBlake2Hash(toSign);
  const signature = module.exports.signEd25519(hash, privateKey);
