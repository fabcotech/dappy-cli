...
module.exports.checkConfig = async (recordOrDapp) => {
  ...
  let config = {
    options: {
      platform: 'rchain',
      readOnly: process.env.DAPPY_RCHAIN_READ_ONLY || 'http://127.0.0.1:40403',
      validator: process.env.DAPPY_RCHAIN_VALIDATOR || 'http://127.0.0.1:40403',
      shardId: process.env.DAPPY_RCHAIN_SHARD_NAME || 'dev',
